...
* Spring boot版本选择
  ...
  * 官网
    ...
    * 最稳定版本为 2.4.3，(截止到2021-3-5)
      ...
      ![图片](E:\file\code\java\study\spring-cloud-study-2.0\images\img3.png)
...
* Spring cloud版本选择
  ...
  * spring cloud 版本使用单词命名
    ...
    ![](E:\file\code\java\study\spring-cloud-study-2.0\images\img4.png)
...
* SpringBoot与SpringCloud的依赖关系
  ...
  * 说明网址 [官网说明网址](https://spring.io/projects/spring-cloud#overview)
    ...
    ![](E:\file\code\java\study\spring-cloud-study-2.0\images\img5.png)

  * 更详细的版本对应查看方法

    * [网址](https://start.spring.io/actuator/info)

      ![](E:\file\code\java\study\spring-cloud-study-2.0\images\img6.png)
...
![](E:\file\code\java\study\spring-cloud-study-2.0\images\img7.png)
